...
public enum TriState implements StringRepresentable {
    ...
    public static final Function<String, TriState> CODEC = StringRepresentable.createNameLookup(values());
     ...
     */
    public <T> Optional<T> map(BooleanFunction<? extends @Nullable T> mapper) {
